...
export const metadata: Metadata = {
  title: "Projets IA, automatisation et opérations",
  description: "Découvrez les projets de Pauline Faussurier : pilotage de performance, suivi commercial et intelligence stratégique appliqués aux opérations.",
  alternates: { canonical: "/projets" },
  openGraph: { url: "/projets", title: "Projets IA, automatisation et opérations | Pauline Faussurier", description: "Trois systèmes concrets pour rendre des situations complexes plus lisibles et pilotables." },
};
